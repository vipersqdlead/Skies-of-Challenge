...
public class SurvivalMissionStatus : MonoBehaviour
{
	...
	string SpawnEnemies()
	{
		...
		int enemyQuantity;
						...
						else if (currentWave > 10 && currentWave <= 14)
                        {
                            enemyQuantity = 5;
                        }
                        else
		...
		switch (aircraftType)
            {
                case AircraftType.Trainer:
                    ...
                    else
                    {
						...
						if(oldMatchmaking)
						{
							waveSpawner.TrainerSpawnWave(enemyQuantity);
						}
                ...
                case AircraftType.Prop:
                    ...
                    else
                    {
						...
						if(oldMatchmaking)
						{
							waveSpawner.PropSpawnWave(enemyQuantity);
						}
                ...
                case AircraftType.JetTier1:
                    ...
                    else
                    {
						...
						if(oldMatchmaking)
						{
							waveSpawner.JetTier1SpawnWave(enemyQuantity);
						}
